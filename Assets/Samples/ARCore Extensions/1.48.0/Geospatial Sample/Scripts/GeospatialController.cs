...
namespace Google.XR.ARCoreExtensions.Samples.Geospatial
{
    ...
    public class GeospatialController : MonoBehaviour
    {
        ...
        /// <summary>
        /// UI element that enables or disables the Occlusion Manager.
        /// </summary>
        ...
        /// <summary>
        /// Callback handling "Occlusion" toggle event in AR View.
        /// </summary>
        /// <param name="enabled">Whether to enable AR Object Occlusions.</param>
        public void OnOcclusionToggled(bool enabled)
        {
            
            if (_AROcclusionManager != null)
            {
                _AROcclusionManager.enabled = enabled;
                Debug.Log($"AR Occlusion is now {(enabled ? "ON" : "OFF")}");
            }
        }
        ...
        public void OnEnable()
        {
            ...
            OcclusionToggle.gameObject.SetActive(true);
            ...
            _AROcclusionManager = Camera.main.GetComponent<AROcclusionManager>();

            if(_AROcclusionManager != null)
            {
                Debug.LogWarning("AROcclusionManager Found!");
            }
        }
